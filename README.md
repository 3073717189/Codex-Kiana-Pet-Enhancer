...
1. 从 [Releases](https://github.com/3073717189/Codex-Kiana-Pet-Enhancer/releases/latest) 下载 `Codex-琪亚娜增强桌宠-v1.0.0-win-x64.zip`。
...
```powershell
Get-FileHash '.\Codex-琪亚娜增强桌宠-v1.0.0-win-x64.zip' -Algorithm SHA256
```
